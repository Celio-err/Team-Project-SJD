...
from .views import dashboard_view, edit_estudante, edit_professor, estudante_create_view, estudante_list_view, hamoos_estudante, hamoos_profesor, professor_create_view, professor_list_view, user_list_view, user_create_view,user_delete_view, perfil_view
...
urlpatterns = [
    ...
    path('konta', perfil_view, name='perfil'),
]